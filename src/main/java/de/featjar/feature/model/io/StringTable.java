...
public class StringTable {
    ...
    public static final String SELECT_THE_FEATURE_MODEL_FOR_THE_CURRENT_PROJECT =
            "Select the feature model for the current project.";
    ...
    public static final String NOTHING_HAS_BEEN_SAVED_FOR_CONFIGURATION_EXPORT___ =
            "Nothing has been saved for configuration export...";
    ...
    public static final String CONFIGURATION_DIALOGS_CONSTRAINT_DECISION_TOOLTIP =
            "Open Constraint View when starting FeatureIDE.";
    public static final String
            THE_CONFIGURATION_EDITOR_PROVIDES_FEATURE_HIGHLIGHTING_FOR_INVALID_CONFIGURATIONS_IN_ODER_TO_FIND_VALID_CONFIGURATIONS_ =
                    "The configuration editor provides feature highlighting for invalid configurations in oder to find valid configurations.";
    public static final String
            LOOKS_FOR_OPEN_CLAUSES_IN_THE_CNF_REPRESENTATION_OF_THE_FEATURE_MODEL_AND_HIGHLIGHTS_THE_CORRESPONDING_FEATURES_ =
    ...
    public static final String
            TRIES_TO_FIND_FEATURES_WHICH_LEAD_TO_A_VALID_CONFIGURATION_BY_SOLVING_A_SATISFIABILITY_PROBLEM_ =
    ...
    public static final String ADD_IMPORTED_FEATURES_ALREADY_IMPORTED_WARNING =
            "At least one of the selected features is already imported.";
    public static final String IMPORT_FEATURE_MODEL = "Import Feature Model";
    public static final String IMPORT_FEATURE_MODEL_DIALOG_TEXT =
            "Please enter the relative path to the model file, and an optional alias.";
    ...
    public static final String IMPORT_FEATURE_MODEL_ERROR_UNKNOWN_IMPORTING_MODEL_FILE =
            "The source file of the importing feature model is unknown.";
    public static final String IMPORT_FEATURE_MODEL_ERROR_NONEXISTENT_PATH = "The import path does not exist.";
    public static final String IMPORT_FEATURE_MODEL_ERROR_NOT_A_FEATURE_MODEL =
            "The import path does not represent a valid feature model.";
    public static final String IMPORT_FEATURE_MODEL_ERROR_IMPORT_CYCLE =
            "The import path is invalid since it causes a cyclic import.";
    public static final String IMPORT_FEATURE_MODEL_ERROR_NAME_ALREADY_EXISTS =
            "An imported model with the given name or alias already exists.";
    public static final String IMPORT_FEATURE_MODEL_ERROR_FORMAT_NAME =
            "The model name is invalid in this feature model format.";
    public static final String IMPORT_FEATURE_MODEL_ERROR_FORMAT_ALIAS =
            "The alias is invalid in this feature model format.";
    ...
    public static final String EDIT_IMPORT_ALIAS_DIALOG_TEXT =
            "Please enter a new alias for the selected model, or leave it empty to set no alias.";
    ...
    public static final String
            MIGRATION_IS_CURRENTLY_NOT_SUPPORTED_FOR_THE_SELECTED_COMPOSER__PLEASE_CHOOSE_ANOTHER_ONE =
    ...
    public static final String
            CANT_SET_CONFIGURATION_AS_CURRENT_CONFIGURATION_BECAUSE_IT_DOES_NOT_BELONG_TO_A_FEATURE_PROJECT =
    ...
    public static final String
            ENTER_THE_NAME_OF_THE_CONFIGURATION_FILE__IT_WILL_BE_PLACED_IN_THE_CONFIGURATIONS_DIRECTORY_OF_THE =
    ...
    public static final String CHANGE_CONFIGURABLE_ATTRIBUTE_VALUE_OPERATION_NAME =
            "Change Configurable Attribute Value";
    ...
    public static final String INVALID_RECURSIVE_ATTRIBUTE_NAME_ERROR_MESSAGE =
            "Please ensure the name is not used by an attribute of a child feature.";
    ...
    public static final String SELECT_FEATURES_IN_FEATURE_DIAGRAM =
            "Select features in feature diagram to show their attributes";
    public static final String NO_CONFIGURABLE_ATTRIBUTES =
            "The feature model does not contain configurable attributes.";
    ...
    public static final String WIKI_DELETING_URL =
            "https://github.com/FeatureIDE/FeatureIDE/wiki/Feature-Model-Edit-Operations#deleting";
    public static final String DELETE_FEATURE_REASON_CONSTRAINTS = "at least one feature is contained in constraints";
    public static final String DELETE_FEATURE_REASON_GROUP_DIFFERENCE =
            "at least one feature has a different group than its parent";
    public static final String DELETE_FEATURE_REASON_ROOT =
            "a feature is the root of the feature diagram and there is no unambiguous remaining root";
    public static final String LIST_BULLET_DASH = "  - ";
    public static final String DELETING_THIS_FEATURE_MAY_RESULT_IN_UNWANTED_CHANGES_AS =
            "Deleting this feature may result in unwanted changes as";
    public static final String DELETING_THESE_FEATURES_MAY_RESULT_IN_UNWANTED_CHANGES_AS =
            "Deleting these features may result in unwanted changes as";
