...
/**
 * A constraint describes some restriction of the valid configurations represented by a {@link FeatureModel}. It is attached to some
...
public class Constraint extends Element implements Mutable<Constraint, Constraint.Mutator>,
    ...
    public class Mutator implements de.featjar.model.util.Mutator<Constraint>,
