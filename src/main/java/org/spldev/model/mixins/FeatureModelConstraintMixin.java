...
import org.spldev.model.Constraint;
...
public interface FeatureModelConstraintMixin {
	...
	interface Mutator extends org.spldev.model.util.Mutator<FeatureModel> {
	...
	interface Analyzer extends org.spldev.model.util.Analyzer<FeatureModel> {
